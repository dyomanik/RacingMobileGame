...
namespace Features.AbilitySystem
{
    ...
    {
        [SerializeField] private GameObject _abilityGunButtonPrefab;
        [SerializeField] private GameObject _abilityJumpButtonPrefab;
        ...
        {
            GameObject objectView = Instantiate(_abilityGunButtonPrefab, _placeForButtons, false);
